...
public class ProductBOImpl implements ProductBO {
    ...
    public boolean save(ProductDTO dto) throws Exception {
        return productDA0.save(new Product(dto.getProductId(),dto.getName(),dto.getPrice(), dto.getDescription(),dto.getImagePath(),new Category(dto.getCategory().getCategoryId(),dto.getCategory().getName(),new ArrayList<>()),new ArrayList<>(),new ArrayList<>()));

    }

    @Override
    public boolean update(ProductDTO dto) throws Exception {
        return productDA0.update(new Product(dto.getProductId(),dto.getName(),dto.getPrice(), dto.getDescription(),dto.getImagePath(),new Category(dto.getCategory().getCategoryId(),dto.getCategory().getName(),new ArrayList<>()),new ArrayList<>(),new ArrayList<>()));
    }
